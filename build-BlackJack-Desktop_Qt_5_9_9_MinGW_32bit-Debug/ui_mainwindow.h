...
public:
    ...
    QSpinBox *spinBox_5;
    QLabel *label_9;
    QGridLayout *gridLayoutLeft_2;
    QPushButton *hitButton_2;
    QPushButton *doubleButton_2;
    QSpacerItem *horizontalSpacerLeft_2;
    QGridLayout *gridLayoutRight_2;
    QPushButton *standButton_2;
    ...
    QSpinBox *spinBox_8;
    QLabel *label_12;
    QGridLayout *gridLayoutLeft_3;
    QPushButton *hitButton_3;
    QPushButton *doubleButton_3;
    QSpacerItem *horizontalSpacerLeft_3;
    QGridLayout *gridLayoutRight_3;
    QPushButton *splitButton_3;
    QPushButton *standButton_3;
    QSpacerItem *horizontalSpacerRight_3;
    ...
    QLabel *label_15;
    QSpinBox *spinBox_11;
    QGridLayout *gridLayoutLeft_4;
    QPushButton *hitButton_4;
    QPushButton *doubleButton_4;
    QSpacerItem *horizontalSpacerLeft_4;
    QGridLayout *gridLayoutRight_4;
    QPushButton *splitButton_4;
    QPushButton *standButton_4;
    QSpacerItem *horizontalSpacerRight_4;
    QGridLayout *gridLayout_21;
    QSpinBox *spinBox_12;
    QLabel *label_16;
    QLCDNumber *lcdNumberExtra_4;
    QWidget *gridLayoutWidget_17;
    QGridLayout *gridLayout_5;
    QGridLayout *gridLayout_24;
    QLabel *label_18;
    QSpinBox *spinBox_14;
    QGridLayout *gridLayoutLeft_5;
    QPushButton *hitButton_5;
    QPushButton *doubleButton_5;
    QSpacerItem *horizontalSpacerLeft_5;
    QGridLayout *gridLayoutRight_5;
    QPushButton *splitButton_5;
    QPushButton *standButton_5;
    QSpacerItem *horizontalSpacerRight_5;
    ...
    QLabel *label_21;
    QSpinBox *spinBox_17;
    QGridLayout *gridLayoutLeft_6;
    QPushButton *doubleButton_6;
    QPushButton *hitButton_6;
    QSpacerItem *horizontalSpacerLeft_6;
    QGridLayout *gridLayoutRight_6;
    QPushButton *splitButton_6;
    QPushButton *standButton_6;
    QSpacerItem *horizontalSpacerRight_6;
    QPushButton *closeButton_6;
    QSpacerItem *horizontalSpacer_20;
    QLCDNumber *lcdNumber_6;
    QLCDNumber *lcdNumberExtra_6;
    ...
    QPushButton *hitButtonExtra_1;
    QPushButton *standButtonExtra_1;
    QPushButton *hitButtonExtra_2;
    QPushButton *hitButtonExtra_3;
    QPushButton *hitButtonExtra_4;
    QPushButton *hitButtonExtra_5;
    QPushButton *hitButtonExtra_6;
    QPushButton *standButtonExtra_2;
    QPushButton *standButtonExtra_3;
...
"                background-color: rgb(255,0,0); }"));
        ...
        gridLayoutWidget_14->setGeometry(QRect(50, 220, 601, 161));
        ...
        gridLayout_2->addItem(horizontalSpacer_28, 0, 6, 1, 1);
...
""));
        ...
        gridLayout_2->addLayout(gridLayout_15, 0, 7, 1, 1);

        lcdNumberExtra_2 = new QLCDNumber(gridLayoutWidget_14);
        lcdNumberExtra_2->setObjectName(QStringLiteral("lcdNumberExtra_2"));
        lcdNumberExtra_2->setStyleSheet(QStringLiteral("background: rgb(66, 20, 20);"));
        lcdNumberExtra_2->setDigitCount(2);
        lcdNumberExtra_2->setProperty("intValue", QVariant(0));

        gridLayout_2->addWidget(lcdNumberExtra_2, 0, 5, 1, 1);
...
""));
        ...
        gridLayoutLeft_2 = new QGridLayout();
        gridLayoutLeft_2->setObjectName(QStringLiteral("gridLayoutLeft_2"));
        hitButton_2 = new QPushButton(gridLayoutWidget_14);
        hitButton_2->setObjectName(QStringLiteral("hitButton_2"));
        ...
        doubleButton_2 = new QPushButton(gridLayoutWidget_14);
        ...
        horizontalSpacerLeft_2 = new QSpacerItem(0, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayoutLeft_2->addItem(horizontalSpacerLeft_2, 0, 2, 1, 1);


        gridLayout_14->addLayout(gridLayoutLeft_2, 0, 0, 2, 1);

        gridLayoutRight_2 = new QGridLayout();
        gridLayoutRight_2->setObjectName(QStringLiteral("gridLayoutRight_2"));
        standButton_2 = new QPushButton(gridLayoutWidget_14);
        ...
        splitButton_2 = new QPushButton(gridLayoutWidget_14);
        ...
        horizontalSpacerRight_2 = new QSpacerItem(0, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayoutRight_2->addItem(horizontalSpacerRight_2, 0, 2, 1, 1);


        gridLayout_14->addLayout(gridLayoutRight_2, 0, 2, 2, 1);


        gridLayout_2->addLayout(gridLayout_14, 1, 0, 1, 8);
        ...
        gridLayoutWidget_15->setGeometry(QRect(60, 400, 591, 121));
...
""));
        ...
        gridLayoutLeft_3 = new QGridLayout();
        gridLayoutLeft_3->setObjectName(QStringLiteral("gridLayoutLeft_3"));
        hitButton_3 = new QPushButton(gridLayoutWidget_15);
        ...
        doubleButton_3 = new QPushButton(gridLayoutWidget_15);
        ...
        horizontalSpacerLeft_3 = new QSpacerItem(0, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayoutLeft_3->addItem(horizontalSpacerLeft_3, 0, 2, 1, 1);


        gridLayout_17->addLayout(gridLayoutLeft_3, 0, 0, 2, 1);

        gridLayoutRight_3 = new QGridLayout();
        gridLayoutRight_3->setObjectName(QStringLiteral("gridLayoutRight_3"));
        splitButton_3 = new QPushButton(gridLayoutWidget_15);
        ...
        standButton_3 = new QPushButton(gridLayoutWidget_15);
        ...
        horizontalSpacerRight_3 = new QSpacerItem(0, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayoutRight_3->addItem(horizontalSpacerRight_3, 0, 2, 1, 1);


        gridLayout_17->addLayout(gridLayoutRight_3, 0, 2, 2, 1);


        gridLayout_3->addLayout(gridLayout_17, 1, 0, 1, 8);
...
""));
        ...
        gridLayout_3->addLayout(gridLayout_18, 0, 7, 1, 1);
...
""));
        ...
        gridLayout_3->addItem(horizontalSpacer_25, 0, 6, 1, 1);

        lcdNumberExtra_3 = new QLCDNumber(gridLayoutWidget_15);
        lcdNumberExtra_3->setObjectName(QStringLiteral("lcdNumberExtra_3"));
        lcdNumberExtra_3->setStyleSheet(QStringLiteral("background: rgb(66, 20, 20);"));
        lcdNumberExtra_3->setDigitCount(2);
        lcdNumberExtra_3->setProperty("intValue", QVariant(0));

        gridLayout_3->addWidget(lcdNumberExtra_3, 0, 5, 1, 1);

        gridLayoutWidget_16 = new QWidget(centralwidget);
        gridLayoutWidget_16->setObjectName(QStringLiteral("gridLayoutWidget_16"));
        gridLayoutWidget_16->setGeometry(QRect(60, 550, 531, 101));
...
"}"));
        ...
        gridLayout_4->addItem(horizontalSpacer_26, 0, 6, 1, 1);
...
""));
        ...
        gridLayoutLeft_4 = new QGridLayout();
        gridLayoutLeft_4->setObjectName(QStringLiteral("gridLayoutLeft_4"));
        hitButton_4 = new QPushButton(gridLayoutWidget_16);
        ...
        doubleButton_4 = new QPushButton(gridLayoutWidget_16);
        ...
        horizontalSpacerLeft_4 = new QSpacerItem(0, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayoutLeft_4->addItem(horizontalSpacerLeft_4, 0, 2, 1, 1);


        gridLayout_20->addLayout(gridLayoutLeft_4, 0, 0, 2, 1);

        gridLayoutRight_4 = new QGridLayout();
        gridLayoutRight_4->setObjectName(QStringLiteral("gridLayoutRight_4"));
        splitButton_4 = new QPushButton(gridLayoutWidget_16);
        ...
        standButton_4 = new QPushButton(gridLayoutWidget_16);
        ...
        horizontalSpacerRight_4 = new QSpacerItem(0, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayoutRight_4->addItem(horizontalSpacerRight_4, 0, 2, 1, 1);


        gridLayout_20->addLayout(gridLayoutRight_4, 0, 2, 2, 1);


        gridLayout_4->addLayout(gridLayout_20, 1, 0, 1, 8);
...
""));
        ...
        gridLayout_4->addLayout(gridLayout_21, 0, 7, 1, 1);

        lcdNumberExtra_4 = new QLCDNumber(gridLayoutWidget_16);
        lcdNumberExtra_4->setObjectName(QStringLiteral("lcdNumberExtra_4"));
        lcdNumberExtra_4->setStyleSheet(QStringLiteral("background: rgb(66, 20, 20);"));
        lcdNumberExtra_4->setDigitCount(2);
        lcdNumberExtra_4->setProperty("intValue", QVariant(0));

        gridLayout_4->addWidget(lcdNumberExtra_4, 0, 5, 1, 1);

        gridLayoutWidget_17 = new QWidget(centralwidget);
        gridLayoutWidget_17->setObjectName(QStringLiteral("gridLayoutWidget_17"));
        gridLayoutWidget_17->setGeometry(QRect(50, 730, 681, 101));
...
""));
        ...
        gridLayoutLeft_5 = new QGridLayout();
        gridLayoutLeft_5->setObjectName(QStringLiteral("gridLayoutLeft_5"));
        hitButton_5 = new QPushButton(gridLayoutWidget_17);
        ...
        doubleButton_5 = new QPushButton(gridLayoutWidget_17);
        ...
        horizontalSpacerLeft_5 = new QSpacerItem(0, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayoutLeft_5->addItem(horizontalSpacerLeft_5, 0, 2, 1, 1);


        gridLayout_24->addLayout(gridLayoutLeft_5, 0, 0, 2, 1);

        gridLayoutRight_5 = new QGridLayout();
        gridLayoutRight_5->setObjectName(QStringLiteral("gridLayoutRight_5"));
        splitButton_5 = new QPushButton(gridLayoutWidget_17);
        ...
        standButton_5 = new QPushButton(gridLayoutWidget_17);
        ...
        horizontalSpacerRight_5 = new QSpacerItem(0, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayoutRight_5->addItem(horizontalSpacerRight_5, 0, 2, 1, 1);


        gridLayout_24->addLayout(gridLayoutRight_5, 0, 2, 2, 1);


        gridLayout_5->addLayout(gridLayout_24, 1, 0, 1, 8);
...
""));
        ...
        gridLayout_5->addLayout(gridLayout_25, 0, 7, 1, 1);
...
"}"));
        ...
        gridLayout_5->addItem(horizontalSpacer_24, 0, 6, 1, 1);
...
""));
        ...
        lcdNumberExtra_5 = new QLCDNumber(gridLayoutWidget_17);
        lcdNumberExtra_5->setObjectName(QStringLiteral("lcdNumberExtra_5"));
        lcdNumberExtra_5->setStyleSheet(QStringLiteral("background: rgb(66, 20, 20);"));
        lcdNumberExtra_5->setDigitCount(2);
        lcdNumberExtra_5->setProperty("intValue", QVariant(0));

        gridLayout_5->addWidget(lcdNumberExtra_5, 0, 5, 1, 1);

        gridLayoutWidget_18 = new QWidget(centralwidget);
        gridLayoutWidget_18->setObjectName(QStringLiteral("gridLayoutWidget_18"));
        gridLayoutWidget_18->setGeometry(QRect(50, 930, 661, 101));
        ...
        gridLayout_6->addLayout(gridLayout_29, 0, 7, 1, 1);

        horizontalSpacer_27 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_6->addItem(horizontalSpacer_27, 0, 6, 1, 1);
        ...
        gridLayoutLeft_6 = new QGridLayout();
        gridLayoutLeft_6->setObjectName(QStringLiteral("gridLayoutLeft_6"));
        doubleButton_6 = new QPushButton(gridLayoutWidget_18);
        ...
        hitButton_6 = new QPushButton(gridLayoutWidget_18);
        ...
        horizontalSpacerLeft_6 = new QSpacerItem(0, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayoutLeft_6->addItem(horizontalSpacerLeft_6, 0, 2, 1, 1);


        gridLayout_28->addLayout(gridLayoutLeft_6, 0, 0, 2, 1);

        gridLayoutRight_6 = new QGridLayout();
        gridLayoutRight_6->setObjectName(QStringLiteral("gridLayoutRight_6"));
        splitButton_6 = new QPushButton(gridLayoutWidget_18);
        ...
        standButton_6 = new QPushButton(gridLayoutWidget_18);
        ...
        horizontalSpacerRight_6 = new QSpacerItem(0, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayoutRight_6->addItem(horizontalSpacerRight_6, 0, 2, 1, 1);


        gridLayout_28->addLayout(gridLayoutRight_6, 0, 2, 2, 1);


        gridLayout_6->addLayout(gridLayout_28, 1, 0, 1, 8);
...
"{background: rgb(98, 8, 8);}"));
        ...
        lcdNumberExtra_6 = new QLCDNumber(gridLayoutWidget_18);
        lcdNumberExtra_6->setObjectName(QStringLiteral("lcdNumberExtra_6"));
        lcdNumberExtra_6->setStyleSheet(QStringLiteral("background: rgb(66, 20, 20);"));
        lcdNumberExtra_6->setDigitCount(2);
        lcdNumberExtra_6->setProperty("intValue", QVariant(0));

        gridLayout_6->addWidget(lcdNumberExtra_6, 0, 5, 1, 1);
...
""));
        ...
        gridLayoutLeft_1 = new QGridLayout();
        gridLayoutLeft_1->setObjectName(QStringLiteral("gridLayoutLeft_1"));
        doubleButton_1 = new QPushButton(gridLayoutWidget_3);
        ...
        hitButton_1 = new QPushButton(gridLayoutWidget_3);
        ...
        horizontalSpacerLeft_1 = new QSpacerItem(0, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayoutLeft_1->addItem(horizontalSpacerLeft_1, 0, 3, 1, 1);
        ...
        splitButton_1 = new QPushButton(gridLayoutWidget_3);
        ...
        horizontalSpacerRight_1 = new QSpacerItem(0, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayoutRight_1->addItem(horizontalSpacerRight_1, 0, 2, 1, 1);
...
""));
        ...
        lcdNumberExtra_1 = new QLCDNumber(gridLayoutWidget_3);
        lcdNumberExtra_1->setObjectName(QStringLiteral("lcdNumberExtra_1"));
        lcdNumberExtra_1->setStyleSheet(QStringLiteral("background: rgb(66, 20, 20);"));
        lcdNumberExtra_1->setDigitCount(2);
        lcdNumberExtra_1->setProperty("intValue", QVariant(0));

        gridLayout_1->addWidget(lcdNumberExtra_1, 0, 5, 1, 1);
...
""));
        ...
        gridLayout_1->addLayout(gridLayout_11, 0, 7, 1, 1);
...
"}"));
        ...
        gridLayout_1->addItem(horizontalSpacer_8, 0, 6, 1, 1);
...
""));
        ...
        gridLayout_1->addItem(horizontalSpacer_1, 0, 4, 1, 1);
...
"}"));
        ...
        sizePolicy5.setHeightForWidth(DealNow->sizePolicy().hasHeightForWidth());
        DealNow->setSizePolicy(sizePolicy5);
        QFont font1;
...
"}"));
        ...
        hitButtonExtra_1 = new QPushButton(centralwidget);
        hitButtonExtra_1->setObjectName(QStringLiteral("hitButtonExtra_1"));
...
"  color: rgb(66, 20, 20);}"));
        ...
        hitButtonExtra_1->raise();
        standButtonExtra_1->raise();
        hitButtonExtra_2->raise();
        hitButtonExtra_3->raise();
        hitButtonExtra_4->raise();
        hitButtonExtra_5->raise();
        hitButtonExtra_6->raise();
        standButtonExtra_2->raise();
        standButtonExtra_3->raise();
